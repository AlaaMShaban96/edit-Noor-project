            ...
            <div class="detail">
              ...
              <div class="form">
                ...
                <form name="subscribe_form" id="subscribe_form" method="post" action="#" onSubmit="return false">
                  <input type="text" data-delay="300" placeholder="Name" name="subscribe_name" id="subscribe_email"
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
            <span class="copyrights">Copyright &copy; <script>
                document.write(new Date().getFullYear());

              </script> Noor Al-Amana. All Right Reserved <a href="{{ URL::to('http://www.nano-tech.ly') }}"
                target="__blink" style="color: #fff;"><b>Nano-Tech </b></a></span>
          </div>

          <div class="col-md-4">
            <div class="social-icons">
              <a href="{{$footer->email()->where('email_type_id',1)->first()==null?"":$footer->email()->where('email_type_id',1)->first()->link}}"
                class="fb"><i class="icon-euro"></i></a>
              <a href="{{$footer->email()->where('email_type_id',4)->first()==null?"":$footer->email()->where('email_type_id',1)->first()->link}}"
                class="tw"><i class="icon-yen"></i></a>
