            ...
            <div class="card" wfd-id="109">
                ...
                <div class="card-content" wfd-id="110">
                    <div class="card-body" wfd-id="111">
                        <form class="form" wfd-id="112" action="{{url('cpanel/admin/job/'.$job->id)}}" method="post">
                            @method('PUT')
                            @csrf
                            @foreach ($job->JobTranslation as $job)
                                <div class="form-body" wfd-id="113">
                                    <div class="row" wfd-id="114">
                                        ...
                                        <div class="col-md-6 col-12" wfd-id="133">
                                            <div class="form-label-group" wfd-id="134">
                                                <textarea  id="last-name-column" class="form-control"  placeholder="description" name="description[]" wfd-id="547" required>{{$job->description}}</textarea>
                                        ...
                                        <div class="col-md-6 col-12" wfd-id="130">
                                            <div class="form-label-group" wfd-id="131">
                                                <textarea  id="responsibility-column" class="form-control" placeholder="responsibility" name="responsibility[]" wfd-id="546" required>{{$job->responsibility}}</textarea>
                                        ...
                                        <div class="col-md-6 col-12" wfd-id="127">
                                            <div class="form-label-group" wfd-id="128">
                                                <textarea   id="qualification-floating" class="form-control" placeholder="qualification"  name="qualification[]" wfd-id="545" required>{{$job->qualification}}</textarea>
                                        ...
                                        <div class="col-md-6 col-12" wfd-id="124">
                                            <div class="form-label-group" wfd-id="125">
                                                <textarea    id="experience-column" class="form-control" placeholder="experience"  name="experience[]" wfd-id="544" required>{{$job->experience}}</textarea>
                                        ...
                                        <div class="col-md-6 col-12" wfd-id="121">
                                            <div class="form-label-group" wfd-id="122">
                                                <textarea    id="skills-column" class="form-control"  placeholder="skills" name="skills[]" wfd-id="544" required>{{$job->skills}}</textarea>
                                        ...
                                        <div class="col-12" wfd-id="115">
                                            ...
                                            <button type="submit" class="btn btn-primary mr-1 mb-1 waves-effect waves-light" wfd-id="583">Update</button>
                                            {{-- <button type="reset" class="btn btn-outline-warning mr-1 mb-1 waves-effect waves-light" wfd-id="582">Reset</button> --}}
                                            <a href="{{url('cpanel/admin/job')}}" class="btn btn-danger mr-1 mb-1">Cancel</a>
